...
module Builder =
  ...
  module Mold =
    ...
    module File =
      ...
      let fromLines (path:string) (content: string list) = File(path, fun () -> content |> String.concat "\n" )
    ...
    module Kustomize =
      ...
      let file (yaml:NamedNode list) = File("kustomization.yaml", fun () -> Yzl.render yaml)
